...
const string strMessageMagic = "oeanc Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s FIC additional fees, %d delta bytes\n",
