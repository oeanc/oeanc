...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Oeanc Core Oeanc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Oeanc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Oeanc transaction") + "\n" +
              "  Oeanc-tx [options] -create [commands]   " + _("Create hex-encoded Oeanc transaction") + "\n" +
              "\n";
